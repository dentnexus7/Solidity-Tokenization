...
class App extends Component {
  state = { loaded: false, kycAddress: "0123", tokenSaleAddress: null, userTokens: 0 };
  ...
  handleBuyTokens = async() => {
    await this.tokenInstance.methods.buyTokens(this.accounts[0]).send({from: this.accounts[0], value: this.web3.utils.toWei("1", "wei")});
  }
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <button type="button" onClick={this.handleKycWhitelisting}>Buy more tokens</button>
      </div>
    );
  }
}
